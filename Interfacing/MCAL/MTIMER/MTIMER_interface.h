...
#define TIMER_FREQ_1KHZ           (TIMER_PRESCALER_64)
...
/**
 * @brief This function is responsible for initializing specific timer channel (0/1/2) with ceratin mode and prescaler
 * 
...
/**
 * @brief This function is responsible for running PWM signal mode with pre-defined frequency and certain duty cycle
 * 
 * @param au8_timerChannel 
 * @param au8_dutyCycle
 */
...
/**
 * @brief This function is used to get the frequency and duty cycle of PWM signal
 * 
 * @param pu8_duty 
 * @param pu32_freq 
 */
